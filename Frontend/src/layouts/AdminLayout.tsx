...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#e8eef4' }}>
      ...
      <aside className={`
        fixed top-0 left-0 h-full z-30 flex flex-col transition-transform duration-300 overflow-hidden
        ...
        <header className="flex items-center justify-between px-6 py-4 flex-shrink-0">
          ...
          <div className="flex items-center gap-4 ml-auto relative">
            <div className="text-right hidden sm:block">
              <div className="font-bold text-sm text-slate-800">{user?.name || user?.fullName || 'Admin'}</div>
